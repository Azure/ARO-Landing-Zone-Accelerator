...
###
    ...
    def set_default(self):
        ...
        if 'pullSecret' not in self.body['properties']['clusterProfile']:
            ...
            pull_secret = self.body['properties']['clusterProfile']['pullSecret']
            self.body['properties']['clusterProfile']['pullSecret'] = json.dumps(bytes.decode(base64.b64decode(pull_secret)))
