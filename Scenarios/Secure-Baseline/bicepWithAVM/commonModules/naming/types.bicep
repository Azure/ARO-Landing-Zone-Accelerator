...
type resourceTypeType= 'resourceGroup' | 'virtualNetwork' | 'subnet' | 'networkSecurityGroup' | 'routeTable' | 'applicationGateway' | 'privateEndpoint' | 'networkInterface' | 'keyVault' | 'diskEncryptionSet' | 'keyVaultKey' | 'userManagedIdentity' | 'azureRedHatOpenShift' | 'virtualMachine' | 'firewall' | 'firewallPolicy' | 'firewallPolicyRuleGroup' | 'bastion' | 'publicIp' | 'logAnalyticsWorkspace' | 'containerRegistry'
